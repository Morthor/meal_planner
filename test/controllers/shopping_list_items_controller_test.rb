...
class ShoppingListItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shopping_list_item" do
    assert_difference('ShoppingListItem.count') do
      post shopping_list_items_url, params: { shopping_list_item: { decimal: @shopping_list_item.decimal, integer: @shopping_list_item.integer, integer: @shopping_list_item.integer, string: @shopping_list_item.string } }
    end
  ...
  test "should update shopping_list_item" do
    patch shopping_list_item_url(@shopping_list_item), params: { shopping_list_item: { decimal: @shopping_list_item.decimal, integer: @shopping_list_item.integer, integer: @shopping_list_item.integer, string: @shopping_list_item.string } }
