...
class ShoppingListsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shopping_list" do
    assert_difference('ShoppingList.count') do
      post shopping_lists_url, params: { shopping_list: { integer: @shopping_list.integer, integer: @shopping_list.integer } }
    end
  ...
  test "should update shopping_list" do
    patch shopping_list_url(@shopping_list), params: { shopping_list: { integer: @shopping_list.integer, integer: @shopping_list.integer } }
